...
`,$t=()=>F.jsx("div",{id:"home",children:F.jsxs(St,{children:[F.jsx(Ct,{children:F.jsx(At,{})}),F.jsxs(Pt,{children:[F.jsxs(Nt,{id:"left",children:[F.jsxs(Lt,{children:["Hi, I am ",F.jsx("br",{}),X.name]}),F.jsxs(zt,{children:["I am a",F.jsx(Rt,{children:F.jsx(Tt,{options:{strings:X.roles,autoStart:!0,loop:!0}})})]}),F.jsx(Dt,{children:X.description}),F.jsx(Mt,{href:X.resume,target:"display",children:"Check Resume"})]}),F.jsx(kt,{id:"right",children:F.jsx(Ft,{fetchpriority:"high",src:pt,alt:pt,loading:"lazy"})})]})]})});export{$t as default};
