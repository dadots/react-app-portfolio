...
`,f=e.img`
  width: 24px;
  height: 24px;
`,u=()=>t.jsx(a,{id:"skills",children:t.jsxs(o,{children:[t.jsx(s,{children:"Skills"}),t.jsx(d,{children:"Here are some of my skills on which I have been working on for the past 5 years."}),t.jsx(l,{children:r.map((i,n)=>t.jsxs(m,{children:[t.jsx(c,{children:i.title}),t.jsx(h,{children:i.skills.map((x,p)=>t.jsxs(g,{children:[t.jsx(f,{alt:x.image,src:x.image}),x.name]},p))},n)]},i.title))})]})});export{u as default};
